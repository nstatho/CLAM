...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping', 'camelyon16_test'])
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/tumor_subtyping_dummy_clean.csv',
                            ...
                            patient_strat= False,
                            ignore=[])
elif args.task == 'camelyon16_test':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/camelyon16.csv',
                                data_dir = os.path.join(args.data_root_dir, 'extracted_features'),
                                shuffle = False,
                                print_info = True,
